...
!function($) {
  ...
  $.fn.imodal = function(option) {
    return this.each(function () {
      // 'this' represents the modal target element
      var $this = $(this), 
        data = $this.data('imodal'), 
        options = $.extend({}, $.fn.imodal.defaults, $this.data(), typeof option == 'object' && option);
      // data('imodal') is the origin imodal object instantiated for the modal target node        
  ...
  $(function () {
    $('body').on('click.imodal.data-api', '[data-toggle="imodal"]', function(e) {
      var $this = $(this), 
        href = $this.attr('href'), 
