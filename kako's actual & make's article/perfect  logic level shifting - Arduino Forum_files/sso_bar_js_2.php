...
function ssoGenerateLogoutBar($username) {
  ...
  $r += '<div class="li"><a href="https://id.arduino.cc/auth/logout/?returnurl=http%3A%2F%2Farduino.cc%2Fforum%2F">Sign out</a></div>';
...
function ssoGenerateLoginBar() {
  ...
  $r += '<div class="lo sep">|</div> ';
  $r += '<div class="lo"><a href="https://id.arduino.cc/auth/login/?returnurl=http%3A%2F%2Farduino.cc%2Fforum%2Findex.php%3Ftopic%3D120246.0">Sign in</a> or ';
  $r += '<a href="https://id.arduino.cc/auth/register/?returnurl=http%3A%2F%2Farduino.cc%2Fforum%2Findex.php%3Ftopic%3D120246.0">Register</a></div>';
  document.getElementById("loginInfo").innerHTML = $r;
}
...
function ssoGenerateNavigationBar($username) {
  $r = '';
    ...
    $r += '<a class="t1" href="http://arduino.cc/forum/">Forum</a> ';
